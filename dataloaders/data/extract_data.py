...
class stock:
    def __init__(self, stock_name, plot_mode: str = None, verbose: bool = False, trade_type: str = "hft") -> None:
    ...
    def get_df_hft(self):
        ...
        file_name = './dataloaders/data/sp500_tickers_A-D_1min_1pppix/' + self.stock_name + '_1min.txt'
        # read data
